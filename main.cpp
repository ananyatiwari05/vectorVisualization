...
float gridZoom = 0.75f; // Starting at 75% zoomed
...
void drawGrid(sf::RenderWindow &window, sf::Font &font)
{
    ...
    // Drawinging grid in center panel
    ...
    // Drawinging vertical grid lines
    ...
    // Drawinging horizontal grid lines
    for (int i = 0; i <= gridExtent * 2; i++)
    {
        int y = startY - i;
...
void drawVectors(sf::RenderWindow &window, const std::vector<sf::Vector2f> &vectors, sf::Font &font, const std::vector<std::string> &labels = {}, const std::vector<sf::Color> &colors = {})
{
    // Create a view for the grid panel to clip content
    sf::View gridView;
    gridView.reset(sf::FloatRect(LEFT_PANEL_WIDTH, 0, GRID_PANEL_WIDTH, WINDOW_HEIGHT));
    ...
    for (size_t i = 0; i < vectors.size(); i++)
    {
        ...
        else
        {
            ...
            {
            case 0:
                vecColor = sf::Color::Blue;
                break;
            case 1:
                vecColor = sf::Color::Yellow;
                break;
            case 2:
                vecColor = sf::Color::Magenta;
                break;
            case 3:
                vecColor = sf::Color::Cyan;
                break;
            }
        }
...
void drawInstructions(sf::RenderWindow &window, sf::Font &font, int inputState)
{
    ...
    // Drawinging input format help if applicable
...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        // Drawinging either the temporary display vectors or the permanent vectors
